...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <img src="./dark/image.png" style="width:100%">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">I'm</span> SUJITH KUMAR.</h1>
    <p>Video Editor and Web Designer.</p>
    <img src="./dark/image.png" alt="boy" class="w3-image" width="992" height="1108">
  </header>

  <!-- About Section -->
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    <h2 class="w3-text-light-grey">SUJITH KUMAR.G</h2>
    <hr style="width:200px" class="w3-opacity">
    <p> Hello dear intrested viewer who has shown a great intrest in me. I am very thankful for your curious vision.
      life is just a play may be we are destinated to know about eachother. If fate can brings us together then i am glad.
    </p>
